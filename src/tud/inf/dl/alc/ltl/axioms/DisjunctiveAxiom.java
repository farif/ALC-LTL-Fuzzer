...
/**
 * DisjunctiveAxiom does the following task(s): 
 * 1. Define the Disjunctive LTLAxiom
 * 
 * @version
 * @author
 */

public class DisjunctiveAxiom implements LTLOWLAxiom {
	...
	public DisjunctiveAxiom(LTLOWLAxiom left, LTLOWLAxiom right) {

		this.operand = "DISJUNCTIONOF";
		this.left = left;
		this.right = right;
