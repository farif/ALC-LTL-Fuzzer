...
/**
 * NegativeAxiom does the following task(s): 
 * 1. Define the Negated LTLAxiom
 * 
 * @version
 * @author
 */

public class NegativeAxiom implements LTLOWLAxiom {

	private String operand;
	private LTLOWLAxiom ltl_axiom;

	public NegativeAxiom(LTLOWLAxiom left) {

		this.operand = "NEGATIONOF";
		this.ltl_axiom = left;
