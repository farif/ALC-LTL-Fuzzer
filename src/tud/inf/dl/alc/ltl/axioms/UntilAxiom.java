...
/**
 * UntilAxiom does the following task(s): 
 * 1. Define the Until LTLAxiom
 * 
 * @version
 * @author
 */

public class UntilAxiom implements LTLOWLAxiom {
	...
	public UntilAxiom(LTLOWLAxiom left, LTLOWLAxiom right) {
		this.operand = "UNTILOF";
		this.left = left;
		this.right = right;
	}
